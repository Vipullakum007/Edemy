                ...
                <div className='p-4'>
                  {chapter.chapterContent.map((lecture, lectureIndex) => (
                    <div key={lectureIndex} className='flex justify-between items-center mb-2'>
                      <span>
                        {lecture.lectureOrder}{'  '}{lecture.lectureTitle} - {lecture.lectureDuration} mins - <a href={lecture.lectureUrl} className='text-blue-500' target='_black'>Link</a>
...

          {
            showPopup && (
              <div className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 z-50'>
                <div className="bg-white bg-opacity-80 text-gray-800 p-6 rounded-lg shadow-xl w-full max-w-md mx-4 relative">
              ...
              <div className='fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50'>
                <div className="bg-white text-gray-700 p-4 rounded relative w-full max-w-80">
                  ...
                  <div className="flex gap-2">
                    <button
                      type='button'
                      className='flex-1 bg-blue-400 text-white px-4 py-2 rounded'
                      onClick={addChapter}
                    >
                      Add
                    </button>
